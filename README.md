...
Although there are a couple of BDD frameworks already available for Delphi, I've found them to be a little... unwieldy... which I assume is because I kept wanting them to be more like StoryQ, and I just didn't connect with the syntax. So, partly out of frustration, and partly because I thought it would be an interesting project to sink my teeth into, I thought I'd throw this together and hope that others think it will be useful.
